...
description: Architecture and core workflows for the AgentStack TypeScript SDK
---

The AgentStack TypeScript SDK builds on the [Agent2Agent Protocol (A2A)](https://a2a-protocol.org/) and provides two layers:
...
- **[Extensions](./extensions)** for service and UI extension handling
- **[API Client](./api-client)** for endpoint reference and error helpers
- **[Error Handling](./error-handling)** for platform and extension error patterns
- **[Message Building](./message-building)** for composing user messages with metadata
- **[A2A Client Integration](./a2a-client-integration)** for end to end streaming with `@a2a-js/sdk`
