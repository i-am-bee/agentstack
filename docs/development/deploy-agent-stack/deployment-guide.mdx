...
|--------|--------------|
|<b>Kubernetes</b>|Version 1.24+ with admin access| 
|<b>Tooling</b>  | Helm 3.8+ and kubectl configured|
|<b>Storage</b>  | 20GB+ available for PostgreSQL|
|<b>Providers</b>| API access for LLMs (OpenAI, Anthropic, etc.)|
|<b>Agent Stack CLI</b>| Agent Stack CLI installed for post-deploy config|
...
| Option| Description |
|--------|--------------|
|<b>Disabled</b>|No security. Simplest for isolated testing.| 
|<b>Basic Auth</b>  | Simple username/password (adminPassword).|
|<b>Bundled Keycloak</b>  | OIDC using an internal instance of Keycloak.|
|<b>External OIDC</b>| Integration with existing Auth0, Okta, or Enterprise IDPs.|
...
- **CLI Applciation:** Consider creating a separate public OIDC application for the CLI
...
- **Validation Toggle:** If you are still experiencing "Invalid Token" errors despite correct audience settings, you can try to disable the check by setting `auth.oidc.validate_audience: false`.