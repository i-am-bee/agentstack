...
Platform extensions enable agents to access external services and UI components through dependency injection. The platform automatically provides configured services based on your agent's function signature.

Extensions make agents portable across different providers, allow users to configure their preferred services, handle authentication automatically, and are optional by design.
