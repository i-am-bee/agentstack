...
## Add Your Agent to BeeAI

Install your agent so BeeAI can run it automatically in the background:
...
What this does:
- Builds your agent into a Docker container
- Lets BeeAI manage starting and stopping it
- You no longer need to run `uv run server` manually
