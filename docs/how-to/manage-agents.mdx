---
title: "Manage Agents"
description: "Learn how to add and manage agents in BeeAI"
---
...
Import agents directly from GitHub repositories that contain proper Dockerfiles:

```bash
# Basic import from main branch
