...
To deploy your agent to Agent Stack, you need to create a github repository with your agent and then deploy from that repository to github.
...
To deploy your agent from github, run:
```bash
...
1. ✓ Builds your Docker image from github
