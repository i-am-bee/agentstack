...
<Info> 
The installer sets up uv and the agentstack-cli on your host machine. For details on what happens under the hood, refer to the Manual Install section below.
</Info>

<Accordion title="Manual Install">

Agent Stack uses a Virtual Machine (managed via a bundled Lima binary) to keep your host machine clean. Components like k3s, Helm, and PostgreSQL live entirely inside the VM and do not touch your host directly.
...
Follow the interactive prompts to finish setup. This starts the VM.
