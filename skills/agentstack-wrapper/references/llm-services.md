...
Before changing LLM wiring, read the [official documentation](https://agentstack.beeai.dev/stable/agent-integration/llm-proxy-service.md) and copy the implementation pattern from the documented examples.

Priority order:

1. Official LLM extension docs (current version).
2. Official example agents from docs/repo.
3. Then apply changes to your project.

If docs and runtime behavior differ, follow installed runtime behavior and note the mismatch.
